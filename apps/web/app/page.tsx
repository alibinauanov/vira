...
export default function Home() {
  ...
  const featureContainerClasses =
    "mt-3 md:mt-2 flex h-full items-stretch justify-start gap-6 md:gap-8 px-4 md:px-12 pb-10 md:pb-3 will-change-transform";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="sticky top-6 md:top-0 h-screen flex flex-col gap-6 md:gap-12 px-0 md:px-8 lg:px-12 xl:px-16 py-8 md:py-20">
              ...
              >
                {features.map((feature, index) => {
                  ...
                  return (
                    <div
                      key={feature.title}
                      className="min-w-[85vw] md:min-w-[540px] lg:min-w-[620px] min-h-[900px] md:min-h-[520px] flex h-full md:h-auto flex-col md:flex-row items-center md:items-start justify-start gap-6 md:gap-10 px-5 md:px-10 lg:px-12 py-8 md:py-12 rounded-3xl bg-white/80 backdrop-blur shadow-sm"
                    >
                        ...
                        {hasGallery && activeGalleryImage ? (
                          <div className="flex flex-col items-center gap-4">
                            <div className="rounded-2xl overflow-hidden bg-white/70 flex items-center justify-center w-full">
                              <img
                                ...
                                style={{ maxHeight: "min(60vh, calc(100vh - 280px))" }}
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="rounded-2xl overflow-hidden flex items-center justify-center">
                            <img
                              ...
                              style={{ maxHeight: "min(55vh, calc(100vh - 280px))" }}
                              loading="lazy"
                            />
                          </div>
                        )}
