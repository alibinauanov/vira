    ...
    <Card className={cn('gap-4', className)}>
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='flex items-center justify-between gap-1'>
          ...
          <ChartContainer id='product-reach' config={productReachChartConfig} className='min-h-13 max-w-18'>
        ...
        <div className='flex items-center justify-between gap-1'>
          ...
          <ChartContainer id='order-placed' config={orderPlacedChartConfig} className='min-h-13 max-w-18'>
